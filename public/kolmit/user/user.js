...
var app = (function () {
    ...
    /* src\user\kolmit\modal\Profile.svelte generated by Svelte v3.40.2 */
    ...
    ***************************************************************************** */
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function profile_1_profile_binding(value) {
    		profile = value;
    		(($$invalidate(2, profile), $$invalidate(0, selected)), $$invalidate(34, event));
    	}
    	...
    	function callbuttonuser_status_binding(value) {
    		status = value;
    		((($$invalidate(1, status), $$invalidate(2, profile)), $$invalidate(0, selected)), $$invalidate(34, event));
    	}
    	...
    	function audioremote_srcObject_binding(value) {
    		if ($$self.$$.not_equal(remote.audio.srcObject, value)) {
    			...
    			((($$invalidate(7, remote), $$invalidate(2, profile)), $$invalidate(0, selected)), $$invalidate(34, event));
    		}
    	}
